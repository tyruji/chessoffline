...
public partial class Queen : Piece
{
    ...
    public override void FillLegalMoveBuffer( Vector2I[] legal_move_buffer, BoardManager board_manager )
    {
        ...
        FillForMovesInDirection( true, ref buffer_idx, new Vector2I( 1, 0 ), legal_move_buffer, board_manager );

        FillForMovesInDirection( true, ref buffer_idx, new Vector2I( -1, 0 ), legal_move_buffer, board_manager );

        FillForMovesInDirection( true, ref buffer_idx, new Vector2I( 0, 1 ), legal_move_buffer, board_manager );
    ...
    public override void FillLegalMoveBufferWithoutCheckChecking( Vector2I[] legal_move_buffer, BoardManager board_manager )
    {
        ...
        FillForMovesInDirection( false, ref buffer_idx, new Vector2I( 1, 0 ), legal_move_buffer, board_manager );

        FillForMovesInDirection( false, ref buffer_idx, new Vector2I( -1, 0 ), legal_move_buffer, board_manager );

        FillForMovesInDirection( false, ref buffer_idx, new Vector2I( 0, 1 ), legal_move_buffer, board_manager );
